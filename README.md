...
![Terminal.app](https://raw.github.com/seboraid/dotfiles/master/iterm/seboraid-terminal.png)
...
- finaly install an [Antivirus](https://www.intego.com/) like Intego
...
- Git aliases
- zsh aliases
- Custom zsh theme with Git and battery status, etc: [nicktheme](zsh/themes/seboraid.zsh-theme)
...
```sh
$ git clone https://github.com/seboraid/dotfiles.git ~/dotfiles
$ cd ~/dotfiles
$ chmod +x setup.sh
$ ./setup.sh
```
...
```sh
sh -c "`curl -fsSL https://raw.github.com/seboraid/dotfiles/master/remote-setup.sh`"
```

Or, using wget:

```sh
sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/seboraid/dotfiles/master/remote-setup.sh`"
```
